...
//     const [clsData, setClsData] = useState([]);
//     const [secData, setSecData] = useState([]);
//     const [showFeeDetails, setShowFeeDetails] = useState(true); // State to manage fee details visibility
//     const [studentinfo, setStudentinfo] = useState({
//         staff_id: "",
//         cls_id: "",
//         scheme: "",
...
//                 break;
//             case "van":
//                 if (!trimmedValue) errmsg = "Please select Transport option";
//                 break;
//             case "stu_name":
//                 if (!trimmedValue) errmsg = "Please enter Student Name";
//                 break;
...
//         if (name === 'scheme') {
//             setShowFeeDetails(value !== "1"); // Show fee details if scheme is not "Yes"
//         }
...
//                 });
//                 setErrors({});
//                 setShowFeeDetails(true); // Reset fee details visibility
//             })
//             .catch((err) => {
//                 console.log("Error:", err);
//             });
...
//                                     onChange={handleChange}
//                                     value={studentinfo.paymentDetails}
...
//                                 color="primary"
//                                 startIcon={<Done />}
//                                 onClick={() => console.log("Scheme Amount Clicked")}
//                             >
//                                 Scheme Amount
//                             </Button>
//                         </Grid>
...
function StudentApplication() {
    ...
    const handleChange = (e) => {
        ...
        if (name === 'scheme') {
            setShowFeeDetails(value !== "1"); // Show fee details if scheme is not "Yes"
            if (value === "2") { // Navigate to Feesallocstudent component if "No" is selected
                // navigate('/Feesslip');
            }
        }
